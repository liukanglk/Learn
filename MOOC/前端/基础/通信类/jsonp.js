...
var callbackName = util.getName('tt_player');  //callbackName:回调名
...
if (opt.url) {
var xhr = XMLHttpRequest ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP'); //判断XHS是否存在 ，后面还考虑了兼容
var data = opt.data,
url = opt.url,
...
//响应
xhr.onload = function () {
if (xhr.status === 200 || xhr.status === 304) {   //监听成功失败
var res;
